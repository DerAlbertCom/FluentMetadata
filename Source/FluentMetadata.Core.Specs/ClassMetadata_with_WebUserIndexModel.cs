...
namespace FluentMetadata.Specs
{
    public class ClassMetadata_with_WebUserIndexModel : MetadataTestBase
    {
        ...
        [Fact] public void ModelName_is_Null() { Assert.Null(classMetadata.ModelName); }
        [Fact] public void ModelType_is_WebUserIndexModel() { Assert.Equal(typeof(WebUserIndexModel), classMetadata.ModelType); }
        [Fact] public void DisplayName_is_Benutzer() { Assert.Equal("Benutzer", classMetadata.GetDisplayName()); }
    }
